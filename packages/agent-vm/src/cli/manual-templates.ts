...
Use https://auth.claw.askluna.xyz:18900 for production or https://auth.claw-beta.askluna.xyz:18900 for beta. Clerk fixedLoginReturnOrigin must match the selected website origin. Before changing origins, prepare DNS-only records, matching TLS certificates, Clerk redirects, and the Google callback at <website-origin>/oauth/google/callback; validate before restarting.

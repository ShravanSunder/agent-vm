...
const requiredPortalPackageExports = [
	...
	'@agent-vm/controller-execution-contracts/controller-execution-data-boundary',
	'@agent-vm/controller-execution-contracts/controller-execution-request-boundary',

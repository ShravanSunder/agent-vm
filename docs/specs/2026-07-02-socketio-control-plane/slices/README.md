...
Execution rule:
- Run `00-gate-0-runtime-provenance.md` before any production slice.
...
Slice order:
1. `00-gate-0-runtime-provenance.md`
2. `01-s1-control-protocol-contracts.md`
3. Parallel after S1: `02-s2-gateway-control-service-placement.md`,
...
4. Parallel after S1+S3: `04-s4a-gateway-control-contract-lease-rpc.md`,
...
5. After caller moves: `05-s4b-controller-route-disposition.md`,
   `07b-s6b-recovery-corroboration.md`
6. Last/removal: `12-s5a-raw-control-removal.md`,
...
- External full-system proof in `../shravan-claw-beta` with actual Discord and
  ...
  local tarballs, reconcile the OpenClaw runtime target, exercise the real
  `#beta-debug`/`pulse-bot` Discord binding, and capture redacted
  controller/OpenClaw/Discord evidence.

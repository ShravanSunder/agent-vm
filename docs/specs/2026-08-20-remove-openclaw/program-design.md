...
| Hermes Python adapter | Maps routed profile identity to Gateway Runtime Tool Portal and sandbox operations | Retained and becomes the sole managed-plugin adapter |
